...
public class Sender {
    ...
    int array[] = { 0,4097,21505,24577,5121,31745,14337,49153,41985,28673,58369,37889,20481,16385,44033,32769};
        ...
        public void run() throws IOException, ClassNotFoundException {
            ...
            while ((slideWin <= Math.pow(2,16)+1) && SegNum<=Math.pow(10,7)){ //need to set this limit to 10Million
                ...
                while ((loopCount < slideWin) && SegNum<=Math.pow(10,7)) { //need to set this limit to 10Million
